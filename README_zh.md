...
<p align="center">
  ...
  <a href="https://nextjs.org/"><img src="https://img.shields.io/badge/Next.js-16_App_Router-black.svg?style=flat&logo=nextdotjs&logoColor=white" alt="Next.js 16 App Router" /></a>
...
**Mystic** 是一套构建在 **Next.js 16 (App Router)**、**React 19**、**TypeScript 6** 与 **Vercel AI SDK（支持 DeepSeek-R1/V3、Claude 3.7、GPT-4o、Gemini 2.0、Ollama 及自定义 BYOK 的全模型引擎）** 之上的**多领域结构化可解释 AI 推演引擎**。
...
<p align="center">
  <a href="https://www.star-history.com/?repos=MeiSiristhebest%2Fmystic&type=date&legend=bottom-right">
    <picture>
      ...
      <img alt="Star History 趋势图" src="https://api.star-history.com/chart?repos=MeiSiristhebest/mystic&type=date&legend=bottom-right&sealed_token=uaVldQgHazK-DcCE89936BEzAUE1ErdhsQqB7B583EJxvNyhoxZkU2soE6gCjSGsdn5TpVFHAzFZx8D-0S5bVhb8lmr1rrsJOU_UV3x9DqHUQ-cQJYtXBw" width="100%" />
    </picture>
  </a>
</p>
