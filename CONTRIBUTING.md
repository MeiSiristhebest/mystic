...
We love your input! We want to make contributing to Mystic as easy and transparent as possible, whether it's:
...
2. Clone your fork: `git clone https://github.com/yourusername/mystic.git`
3. Install dependencies: `pnpm install`
4. Set up environment variables (Firebase, Gemini API keys — see README.md)
